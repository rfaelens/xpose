...
* If `facets` is a string e.g `facets = "OCC"`, `ggforce::facet_wrap_paginate` will be used
* If `facets` is a formula e.g `facets = SEX~OCC`, `ggplot2::facet_grid_paginate` will be used
