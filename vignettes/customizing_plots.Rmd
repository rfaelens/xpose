...
```{r demo type, echo = FALSE, fig.height = 2.5, fig.width = 6, out.width = '100%'}
...
```{r demo gg_theme, echo = FALSE, fig.height = 6, fig.width = 6, out.width = '100%'}
gridExtra::grid.arrange(
...
```{r demo xp_theme, echo = FALSE, fig.height = 4, fig.width = 6, out.width = '100%'}
gridExtra::grid.arrange(
