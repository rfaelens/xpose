...
### Plot type
The option `type` allows to control how the data should be represented i.e. whether to use points `'p'`, lines `'l'`, smooth `'s'`, text `'t'` or any combination of the three (e.g. `type = 'pl'`).

```{r demo type, echo = FALSE, fig.height = 6, fig.width = 6, out.width = '75%'}
