...
#' names of the output tables to import will be generated by combining the table_names argument with the tab_suffix or sim_suffix arguments as in the Xpose4 package. Tables will be 
#' constructed using the following elements in this order: dir, tab_names, runno, tab/sim_suffix to create file names such as pk/models/sdtab001 or pk/models/sdtab001sim.
#' @param tab_names Only used when \code{manual_import} is set to \code{TRUE}. Provide the name of the tables to import e.g. 'sdtab', 'patab', 'cotab', 'catab' for NONMEM.
#' @param tab_suffix Only used when \code{manual_import} is set to \code{TRUE}. Default is '', but can be changed to any character string to be used as suffix in the 
#' table names.
#' @param sim_suffix Only used when \code{manual_import} is set to \code{TRUE}. Default is 'sim', but can be changed to any character string to be used as suffix in the 
#' simulation table names.
