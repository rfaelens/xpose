...
#' in presentation or papers. Background and grid lines were dimed to focus
#' the attention on the data itself.
#'
...
theme_readable <- function(base_size = 11, legend.position = 'right'){
  theme(
    ...
    # Axis labels
    axis.text = element_text(size = rel(1.1), face = 'bold', color = 'black'),
    ...
    # Minor grid
    panel.grid.minor = element_line(color = 'grey88', size = 0.1),
