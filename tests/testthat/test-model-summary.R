...
test_that('summary is properly created with the appropriate information', {
  ...
  expect_equal(sum_out(sum_timestart(model, software)), c('timestart', 'Fri Sep 1 01:27:25 CEST 2017'))
  expect_equal(sum_out(sum_timestop(model, software)), c('timestop', 'Fri Sep 1 01:27:36 CEST 2017'))
