...
test_that("summary is properly created with the appropriate information", {
  ...
  #expect_equal(sum_out(sum_subroutine(model, software)), c('subroutine', 'na'))
  #expect_equal(sum_out(sum_runtime(model, software)), c('runtime', 'na'))
  #expect_equal(sum_out(sum_covtime(model, software)), c('covtime', 'na'))
  #expect_equal(sum_out(sum_warnings(model, software)), c('warnings', 'na'))
  #expect_equal(sum_out(sum_errors(model, software)), c('errors', 'na'))
  #expect_equal(sum_out(sum_nsig(model, software)), c('nsig', 'na'))
  #expect_equal(sum_out(sum_condn(model, software)), c('condn', 'na'))
  #expect_equal(sum_out(sum_nnpde(model, software)), c('nnpde', 'na'))
  #expect_equal(sum_out(sum_npdeseed(model, software)), c('npdeseed', 'na'))
...
test_that("summary default summary is returned for missing information", {
  ...
  expect_equal(sum_out(sum_condn(model2, software)), c('condn', 'na'))
  expect_equal(sum_out(sum_nnpde(model2, software)), c('nnpde', 'na'))
  expect_equal(sum_out(sum_npdeseed(model2, software)), c('npdeseed', 'na'))
