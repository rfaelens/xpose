...
test_that('summary is properly created with the appropriate information', {
  ...
  expect_equal(sum_out(sum_timestart(model, software)), c('timestart', 'Mon Jun 19 01:13:13 CEST 2017'))
  expect_equal(sum_out(sum_timestop(model, software)), c('timestop', 'Mon Jun 19 01:13:48 CEST 2017'))
  ...
  expect_equal(sum_out(sum_runtime(model, software)), c('runtime', '00:00:15'))
  expect_equal(sum_out(sum_covtime(model, software)), c('covtime', '00:00:15'))
  ...
  expect_equal(sum_out(sum_condn(model, software, rounding)), c('condn', '6.05'))
  ...
  expect_equal(sum_out(sum_ofv(model, software)), c('ofv', '-1518.108'))
  ...
  expect_equal(sum_out(sum_shk(model, software, 'eps', rounding)), c('epsshk', '6.99 [1]'))
