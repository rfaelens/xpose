...
test_that("summary is properly created with the appropriate information", {
  ...
  expect_equal(sum_out(sum_timestart(model, software)), c('timestart', 'Tue Jun 13 14:48:35 CEST 2017'))
  expect_equal(sum_out(sum_timestop(model, software)), c('timestop', 'Tue Jun 13 14:48:50 CEST 2017'))
