...
$INPUT      ID OCC XAT2=DROP DGRP=DROP DOSE FLAG=DROP ONO=DROP
            XIME=DROP DV NEUY=DROP SCR AGE SEX CLASS WT DROP ACE MED1
            MED2 NUMB=DROP TAD TIME VIDD=DROP CLCR AMT SS II DROP
            CMT=DROP CONO=DROP LNDV=DROP EVID=DROP OVID=DROP DROP
            SHR2=DROP
...
$TABLE      ID OCC DOSE AMT SS II TIME TAD IPRED CWRES CPRED IWRES
            EVID A1 A2 ONEHEADER NOPRINT FILE=sdtab001 ; Simple table
